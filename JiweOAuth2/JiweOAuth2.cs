...
public partial class JiweOAuth2 : Node
{
    ...
    private async void doOAuth()
    {
        ...
        string authorizationRequest = string.Format("{0}?response_type=code&scope=openid%20profile%20in-app-purchases%20rewards&redirect_uri={1}&client_id={2}&state={3}&code_challenge={4}&code_challenge_method={5}",
